...
> Current state snapshot as of commit `4791072` (2026-09-11).
> Generated by full codebase audit. Source code is the single source of truth.
...
| Frontend version | `v11` (`WEB_BUILD_VERSION` in `webPwa.js`, `BUILD_VERSION` in `build-web.mjs`) |
| SW cache | `aster-v11` |
